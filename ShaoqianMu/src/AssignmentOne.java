...
public class AssignmentOne {
    public static void main(String[] args) {
        // 第 3 部分 - 使用类和对象
        HealthProfessional gp1 = new GeneralPractitioner(322, "Dr. Zhang", "General Practitioner","123-456-7890");
        HealthProfessional gp2 = new GeneralPractitioner(252, "Dr. Liu", "Family Medicine Specialist","123-123-1234");
